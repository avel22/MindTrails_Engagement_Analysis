...
#OA
oa_imputed <- read.csv(here("Imputation","Blimp","OASIS","Actual_Imputation","OA_imps_mod0.csv"),header = F)
...
#DASS21
dass21_imputed <- read.csv(here("Imputation","Blimp","DASS21","Actual_Imputation","DASS21_imps_mod0.csv"),header = F)
...
#RR_NEG
rr_neg_imputed <- read.csv(here("Imputation","Blimp","RR_NEG_BIAS","Actual_Imputation","RR_NEG_BIAS_imps_mod0.csv"),header = F)
...
#RR_POS
rr_pos_imputed <-  read.csv(here("Imputation","Blimp","RR_POS_BIAS","Actual_Imputation","RR_POS_BIAS_imps_mod0.csv"),header = F)
...
#BBSIQ
bbsiq_imputed <- read.csv(here("Imputation","Blimp","BBSIQ","Actual_Imputation","BBSIQ_imps_mod0.csv"),header = F)
...
#save mitml lists
save.image(here("Data","RData","6_3_imputed_outcomes_mitml_lists.RData"))
