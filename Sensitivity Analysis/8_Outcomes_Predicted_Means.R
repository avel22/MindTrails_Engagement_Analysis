...
compute_pred_means_4 <- function(modelList) {
  ...
  pred_means$eng_cluster_encoded <- ifelse(pred_means$eng_cluster == "More Time Spent", 1, 0)
  ...
  for (i in 1:nrow(pred_means)) {
    ...
    ctr <- paste0("(Intercept) + ",
                  "eng_labelMore Time Spent * ", eng_cluster_encoded, " + ",
                  "t1 * ", t1, " + ",
                  "t2 * ", t2, " + ",
                  "`t1:eng_labelMore Time Spent` * (", t1, "*", eng_cluster_encoded, ") + ",
                  "`t2:eng_labelMore Time Spent` * (", t2, "*", eng_cluster_encoded, ") +",
                  "cred_on_gmc * ",0)
...
png(here("Figures","8_Outcomes_Predicted_Means","all_est_means_outcomes.png"), units="in", width=10, height=8, res=300)
est_means_outcomes
dev.off()

png(here("Figures","8_Outcomes_Predicted_Means","oa_means_outcomes.png"), units="in", width=10, height=8, res=300)
p_OA
dev.off()

png(here("Figures","8_Outcomes_Predicted_Means","dass21_means_outcomes.png"), units="in", width=10, height=8, res=300)
p_dass21
dev.off()

png(here("Figures","8_Outcomes_Predicted_Means","rr_neg_means_outcomes.png"), units="in", width=10, height=8, res=300)
p_rr_neg
dev.off()

png(here("Figures","8_Outcomes_Predicted_Means","rr_pos_means_outcomes.png"), units="in", width=10, height=8, res=300)
p_rr_pos
dev.off()

png(here("Figures","8_Outcomes_Predicted_Means","bbsiq_means_outcomes.png"), units="in", width=10, height=8, res=300)
p_bbsiq
dev.off()
