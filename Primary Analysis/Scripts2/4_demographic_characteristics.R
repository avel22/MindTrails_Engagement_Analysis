...
save(dat.3, file = here("Scripts2","Data_Primary_Analysis","dat.3.RData"))
...
#save dem_table
save(dem_tbl,file = here("Scripts2","Data_Primary_Analysis","dem_tbl.RData"))
...
sink(here("Scripts2","Tables_Figures","Tables","desrciptive_dem_all_cluster.txt"))
...
write.csv(desrciptive_dem_all_697, 
          here("Scripts2","results","desrciptive_dem_all_697.csv"), row.names = FALSE)
write.csv(desrciptive_dem_all_697_cluster, 
          here("Scripts2","results","desrciptive_dem_all_697_cluster.csv"), row.names = FALSE)
