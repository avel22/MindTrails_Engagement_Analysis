...
load(here("Scripts2","Data_Primary_Analysis","aux_vars.RData"))
...
#OASIS
write.table(blimp_oa,here("Scripts2","Data_Primary_Analysis","imputation",paste0("MOD",as.character(mod)),paste0("blimp_imputation_oa_mod",as.character(mod),".csv")),row.names = F,col.names = F)

#DASS21
write.table(blimp_dass21,here("Scripts2","Data_Primary_Analysis","imputation",paste0("MOD",as.character(mod)),paste0("blimp_imputation_dass21_mod",as.character(mod),".csv")),row.names = F,col.names = F)

#BBSIQ
write.table(blimp_bbsiq,here("Scripts2","Data_Primary_Analysis","imputation",paste0("MOD",as.character(mod)),paste0("blimp_imputation_bbsiq_mod",as.character(mod),".csv")),row.names = F,col.names = F)

#RR POSITIVE BIAS
write.table(blimp_rr_pos_bias,here("Scripts2","Data_Primary_Analysis","imputation",paste0("MOD",as.character(mod)),paste0("blimp_imputation_rr_pos_mod",as.character(mod),".csv")),row.names = F,col.names = F)

#RR NEGATIVE BIAS
write.table(blimp_rr_neg_bias,here("Scripts2","Data_Primary_Analysis","imputation",paste0("MOD",as.character(mod)),paste0("blimp_imputation_rr_neg_mod",as.character(mod),".csv")),row.names = F,col.names = F)
